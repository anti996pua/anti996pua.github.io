...
1. 设计并实施了 X，这是 CRM 系统的一项新功能，可使 2 万名用户轻松跟踪他们的业务支出。
2. 通过使用 OAuth 和 JavaScript，实现了社交网站登录和个人资料自动填充，将网站的转化率提高了 20％。
3. 使用 Ajax 技术减少了 30％的页面加载时间。
4. 与后端工程师团队合作，一起开发、部署、故障排查了 7 个的 Web 应用程序。
5. 与一个同事合作，在一周内，将网站前端转换为 React 框架。
6. 使用 Less 开发了一个客户端的全新 CSS 样式，使文件大小减少了 70％，将首屏显示的时间减少了 2 倍。
...
> **本文转自 [reverse-interview-zh](https://github.com/yifeikong/reverse-interview-zh)，可以参见反向面试。**
